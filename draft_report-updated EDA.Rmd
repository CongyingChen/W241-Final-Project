...
```{r pressure, echo=FALSE, fig.cap="Experimental Design", out.width = '50%', fig.align='center'}
...
```{r pressure, echo=FALSE, fig.cap="Example of Survey Guidelines", out.width = '100%', fig.align='center'}
...
```{r pressure, echo=FALSE, fig.cap="Experiment Progression", out.width = '100%', fig.align='center'}
...
d.v1 <- meatadata[(rowSums(is.na(d))) <= 2,]
...
d.transformed <- melt(d.v1[,1:25], id.vars = c("ID","Treatment","Sex","Age","Income","Household Vegetarian","How many people, including yourself, are in your household?","Interest_Level","TreatmentDay","Reasons","Education"))
